...
> [!NOTE]
> 正式版请只从本仓库的 [Releases](https://github.com/Sakura-Lhy0409/M-Control-Releases/releases) 下载，并核对发布页提供的 SHA256。大多数用户选择安装包；免安装可选普通便携版；无法安装或加载系统 WebView2 的电脑可选真正内嵌 Fixed Version Runtime 的便携版。
